	...
	>
		{#if article.cover}
			...
			<div class="space-y-2 flex-1 md:space-y-4">
				<h3
					class="text-2xl font-medium text-zinc-900 dark:text-zinc-100 group-hover:text-teal-600 dark:hover:text-teal-400"
				>
					{article.title}
				</h3>
				<p
		...
		{:else}
			<div class="space-y-2 md:space-y-4">
				<h3
					class="text-2xl font-medium text-zinc-800 dark:text-zinc-100 group-hover:text-teal-600 dark:hover:text-teal-400"
				>
					{article.title}
				</h3>
				<p
