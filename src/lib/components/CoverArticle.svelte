	...
	>
		{#if article.cover}
			...
			<div class="col-span-1 space-y-6 md:space-y-8">
				<h3 class="text-4xl font-serif font-bold text-zinc-800 dark:text-zinc-100 group-hover:text-teal-600 dark:hover:text-teal-400">
					{article.title}
				</h3>
		...
		{:else}
			...
			<div class="space-y-8 col-span-2">
				<h3 class="text-5xl font-serif font-bold text-zinc-800 dark:text-zinc-100 group-hover:text-teal-600 dark:hover:text-teal-400">
					{article.title}
				</h3>
				<p class="text-zinc-600 leading-7 line-clamp-3 text-ellipsis dark:text-zinc-400 group-hover:text-zinc-500">
					{article.description}
