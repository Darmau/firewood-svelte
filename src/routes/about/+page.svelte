				...
				<div class="lg:flex lg:flex-auto lg:justify-center">
					<dl class="w-64 space-y-8 xl:w-80">
						<div class="flex flex-col-reverse gap-y-4">
							<dt class="text-base leading-7 text-gray-600">收录文章</dt>
							<dd class="text-5xl font-semibold tracking-tight text-gray-900">{data.article}篇</dd>
						</div>
						<div class="flex flex-col-reverse gap-y-4">
							<dt class="text-base leading-7 text-gray-600">收录博客</dt>
							<dd class="text-5xl font-semibold tracking-tight text-gray-900">{data.website}个</dd>
						</div>
					</dl>
				</div>
			</div>
